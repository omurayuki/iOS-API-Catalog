...
extension CGImageSource {
    ...
    @available(iOS 13.0, *)
    private var semanticSegmentationEffectsSkinMatteDataInfo: [String : AnyObject]? {
    ...
    @available(iOS 13.0, *)
    func getSkinMatteData() -> AVSemanticSegmentationMatte? {
        if let info = semanticSegmentationEffectsSkinMatteDataInfo {
